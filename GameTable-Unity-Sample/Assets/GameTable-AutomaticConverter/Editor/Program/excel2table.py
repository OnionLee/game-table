...
class Converter:
    ...
    def __init__(self, pretty_print, converter_type, export_path):
    ...
    def convert(self, filename):
        ...
        print(self.converter_type + ' : ' + only_filename[-1] + ' convert starting...')
        ...
        print(self.converter_type + ' : ' + only_filename[-1] + ' convert is Done\n')
